<div class="modal fade" tabindex="-1" id="updateWarningOrganizationModal">
    <div class="modal-dialog">
        <form action="{{ route('organizations.warnings.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Загрузите файл с проблемными контрагентами</h4>
                </div>
