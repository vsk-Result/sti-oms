            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Новое списание</span>
                    </h3>
                </div>
                <div class="card-body py-3">
                    <form class="form" action="{{ route('writeoffs.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
