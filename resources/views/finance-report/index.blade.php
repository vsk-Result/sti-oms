...
{{--                        />--}}
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">
                            <div class="menu-item px-3 mb-3">
                                <form action="{{ route('finance_report.exports.store', ['balance_date' => $date->format('Y-m-d')]) }}" method="POST" class="hidden">
                                    @csrf
                                    <a
                            ...
                            <div class="menu-item px-3">
                                <form action="{{ route('finance_report.exports.store', ['balance_date' => $date->format('Y-m-d'), 'show_closed_objects' => true]) }}" method="POST" class="hidden">
                                    @csrf
                                    <a
                                            href="javascript:void(0);"
                                            class="menu-link"
