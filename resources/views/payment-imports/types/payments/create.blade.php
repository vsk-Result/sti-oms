...
@section('toolbar-title', 'Загрузка оплат из Excel')
@section('breadcrumbs', Breadcrumbs::render('payment_imports.types.payments.create'))
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Загрузка оплат из Excel</span>
                    </h3>
                </div>
                <div class="card-body py-3">
                    ...
                    <form class="form" action="{{ route('payment_imports.types.payments.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
