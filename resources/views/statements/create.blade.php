...
@section('toolbar-title', 'Загрузить выписку')
@section('breadcrumbs', Breadcrumbs::render('statements.create'))
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Новая выписка</span>
                    </h3>
                </div>
                <div class="card-body py-3">
                    @if ($errors->any())
                        <div class="alert alert-dismissible bg-light-danger border border-dashed border-danger d-flex flex-column flex-sm-row p-5 mb-10">
                            <div class="d-flex flex-column pe-0 pe-sm-10">
                                <h5 class="mb-1">Ошибки при загрузки выписки</h5>
                                <ul>
                    ...
                    <form class="form" action="{{ route('statements.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-6 fv-row">
                                    ...
                                    <select name="bank_id" class="form-select form-select-solid">
                        ...
                        <div class="d-flex flex-center py-3">
                            ...
                            <a href="{{ route('statements.index') }}" class="btn btn-light">Отмена</a>
                        </div>
                    </form>
                </div>
            </div>
