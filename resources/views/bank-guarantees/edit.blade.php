...
@section('title', 'Изменение банковской гарантии')
@section('toolbar-title', 'Изменение банковской гарантии')
@section('breadcrumbs', Breadcrumbs::render('bank_guarantees.edit', $guarantee))
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Изменение банковской гарантии</span>
                    </h3>
                </div>
                <div class="card-body py-3">
                    <form class="form" action="{{ route('bank_guarantees.update', $guarantee) }}?return_url={{ request()->get('return_url', '') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-5">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <select name="contract_id" data-control="select2" class="form-select form-select-solid form-select-lg">
                                                    <option value="null" {{ $guarantee->contract_id === null ? 'selected' : '' }}>Отсутствует</option>
                                            ...
                                            <div class="position-relative mb-3">
                                                <select name="target" data-control="select2" class="form-select form-select-solid form-select-lg">
                                                    @foreach($targets as $target)
                                                        <option value="{{ $target }}" {{ $target === $guarantee->target ? 'selected' : '' }}>{{$target }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="position-relative mb-3">
                                                <select name="bank_id" data-control="select2" class="form-select form-select-solid form-select-lg">
                                                    @foreach($banks as $bankId => $bankName)
                                                        <option value="{{ $bankId }}" {{ $bankId === $guarantee->bank_id ? 'selected' : '' }}>{{ $bankName }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <input
                                                    ...
                                                    type="text"
                                                    name="start_date"
                                                    value="{{ old('start_date', $guarantee->start_date) }}"
                                                    readonly
                                                />
                                            </div>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <input
                                                    ...
                                                    type="text"
                                                    name="end_date"
                                                    value="{{ old('end_date', $guarantee->end_date) }}"
                                                    readonly
                                                />
                                            </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input
                                                ...
                                                type="text"
                                                name="commission"
                                                value="{{ old('commission', $guarantee->commission) }}"
                                                required
                                            />
                                        </div>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <input
                                                    ...
                                                    value="{{ old('start_date_deposit', $guarantee->start_date_deposit) }}"
                                                    readonly
                                                />
                                            </div>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <input
                                                    ...
                                                    value="{{ old('end_date_deposit', $guarantee->end_date_deposit) }}"
                                                    readonly
                                                />
                                            </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input
                                                ...
                                                type="text"
                                                name="amount_deposit"
                                                value="{{ old('amount_deposit', $guarantee->amount_deposit) }}"
                                            />
                                        </div>
