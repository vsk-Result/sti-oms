            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input id="search-users" type="text" class="form-control form-control-solid w-250px ps-14" placeholder="Поиск" />
                    </div>
                </div>
                <div class="card-toolbar">
                    <button type="button" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#filterUsersModal">
            ...
            <div class="card-body pt-0">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="users-table">
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @forelse($usersGroupedBySuccessLoginDate as $date => $users)
                            @continue($users->count() === 0)

                            <tr>
                                <td colspan="7">
                                    <p class="text-left text-dark fw-bolder d-block m-0 fs-6 ps-3">
                                        <span class="badge badge-light-danger fs-7 fw-bolder">{{ $date }}</span>
                                    </p>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    <td class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('users.show', $user) }}"><span class="text-gray-800 mb-1 user-name">{{ $user->name }}</span></a>
...
@push('scripts')
    <script>
        ...
        const filterUsersTable = (query) => {
            $usersTable.find('tbody tr').show();
