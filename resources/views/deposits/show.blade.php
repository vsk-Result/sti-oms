            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Депозит #{{ $deposit->id }}</span>
                    </h3>

                    <div class="card-toolbar">
                        @can('edit deposits')
                            <a href="{{ route('deposits.edit', $deposit) }}" class="btn btn-sm btn-primary me-3">Изменить</a>
                        @endcan
                    </div>
                </div>
                <div class="card-body py-3">
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        <div class="flex-grow-1">
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-10 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $deposit->getStartDateFormatted() }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-10 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $deposit->getEndDateFormatted() }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-10 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ \App\Models\CurrencyExchangeRate::format($deposit->amount, $deposit->currency) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-10 fv-row">
                                    <span class="fw-bold text-gray-800 fs-6">{{ $deposit->createdBy->name }}</span>
                                    <span class="text-muted fw-bold text-muted fs-7">({{ $deposit->created_at->format('d/m/Y H:i') }})</span>
                                </div>
                            </div>
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-10 fv-row">
                                    @if ($deposit->updatedBy)
                                        <span class="fw-bold text-gray-800 fs-6">{{ $deposit->updatedBy->name }}</span>
                                        <span class="text-muted fw-bold text-muted fs-7">({{ $deposit->updated_at->format('d/m/Y H:i') }})</span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-10 fv-row">
                                    @include('partials.status', ['status' => $deposit->getStatus()])
                                </div>
                            </div>
                            ...
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-10 fv-row">
                                    @foreach($deposit->getMedia() as $media)
                    ...
                    <div class="d-flex flex-center py-3">
                        <a href="{{ route('deposits.index') }}" class="btn btn-light">Отменить</a>
                    </div>
                </div>
            </div>
        </div>
