...
@section('title', 'История депозитов')
@section('toolbar-title', 'История депозитов')
@section('breadcrumbs', Breadcrumbs::render('deposits.history.index'))

@section('content')
    @include('deposits.history.modals.filter')
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <button type="button" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#filterDepositsHistoryModal">
                    ...
                    <table class="table table-hover align-middle table-row-dashed fs-6">
                        <thead>
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px">Депозит</th>
                                ...
                                @foreach($audit->getModified() as $fieldName => $changes)
                                    ...
                                    @if (array_key_exists($fieldName, $fieldsArray))
                                        <tr>
                                            ...
                                            <td>
                                                @if ($audit->auditable)
                                                    <a href="{{ route('deposits.edit', $audit->auditable) }}">БГ #{{ $audit->auditable->id }}</a>
                                                @else
