            ...
            <div class="row">
                ...
                @can('index payments')
                                    ...
                                    <div class="col-md-12 fv-row mb-5">
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                @php
                                                    $months = [];
                                                    foreach (['2026', '2025', '2024', '2023', '2022', '2021'] as $year) {
                    ...
                    <div class="col-md-4">
                        <div class="card mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Разбить страховые взносы</span>
                                </h3>
                            </div>
                            <div class="card-body py-3">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Разбить НДФЛ</span>
                                </h3>
                            </div>
                            <div class="card-body py-3">
                ...
                @if (auth()->user()->hasRole('super-admin'))
                    ...
                    <div class="col-md-4">
                        <div class="card mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Загрузка банковских гарантий</span>
                                </h3>
                            </div>
                            <div class="card-body py-3">
                                <form class="form" action="{{ route('bank_guarantees.import.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="col-md-4">
                        <div class="card mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Загрузка переноса оплат контрагентов</span>
                                </h3>
                            </div>
                            <div class="card-body py-3">
                ...
                <div class="col-md-4">
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">Определение НДС у оплат</span>
                            </h3>
                        </div>
                        <div class="card-body py-3">
                            <form class="form" action="{{ route('payments.nds.store') }}" method="POST">
                                @csrf

                                <div class="d-flex flex-center py-3">
                                    <button type="submit" class="btn btn-primary me-3">
                                        <span class="indicator-label">Определить</span>
                                    </button>
                                </div>
                            </form>
                        </div>
