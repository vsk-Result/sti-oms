<div class="modal fade" tabindex="-1" id="filterTaxPlanHistoryModal">
        ...
        <div class="modal-content">
            ...
            <form action="{{ request()->url() }}" method="GET">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select
                                    ...
                                    data-dropdown-parent="#filterTaxPlanHistoryModal"
                                    data-allow-clear="true"
                                    multiple
                                >
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" {{ in_array($user->id, request()->input('user_id', [])) ? 'selected' : '' }}>{{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button id="filter-bg-history-submit" type="submit" class="btn btn-primary">Применить</button>
                </div>
            </form>
        </div>
    </div>
