<div class="modal fade" tabindex="-1" id="filterPaymentHistoryModal">
        ...
        <div class="modal-content">
            ...
            <form action="{{ request()->url() }}" method="GET">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select
                                    ...
                                    data-dropdown-parent="#filterPaymentHistoryModal"
                ...
                <div class="modal-footer">
                    ...
                    <button id="filter-payment-history-submit" type="submit" class="btn btn-primary">Применить</button>
                </div>
            </form>
        </div>
    </div>
