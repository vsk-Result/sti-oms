                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <select name="period_start" data-control="select2" class="form-select form-select-solid form-select-lg">
                                                    <option value="{{ null }}" {{ empty($act->getPeriod()[0]) ? 'selected' : '' }}>Не указано</option>
                                                    @foreach($months as $month)
                                                        <option value="{{ $month }}" {{ $act->getPeriod()[0] === $month ? 'selected' : '' }}>{{ $month }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6">
                                                <select name="period_end" data-control="select2" class="form-select form-select-solid form-select-lg">
                                                    <option value="{{ null }}" {{ empty($act->getPeriod()[1]) ? 'selected' : '' }}>Не указано</option>
                                                    @foreach($months as $month)
                                                        <option value="{{ $month }}" {{ $act->getPeriod()[1] === $month ? 'selected' : '' }}>{{ $month }}</option>
                                                    @endforeach
                                                </select>
