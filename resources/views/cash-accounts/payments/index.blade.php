        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <button type="button" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#cashAccountFilterPaymentModal">
                    ...
                    <div>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <form action="{{ route('cash_accounts.payments.exports.store', $cashAccount) }}?all=true" method="POST" class="hidden">
                                    @csrf
                ...
                <table class="table table-hover align-middle table-row-dashed fs-7">
                    ...
                    @forelse($payments as $payment)
                        <tr data-payment-update-url="{{ route('cash_accounts.payments.update', [$cashAccount, $payment]) }}">
                            ...
                            <td>
                                @if ($payment->isObjectType() && !$payment->isClosed())
