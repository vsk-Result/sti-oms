...
@section('content')
    <form class="form w-100" action="{{ route('register') }}" method="POST">
        ...
        <div class="mb-10 text-center">
            <h1 class="text-dark mb-3">Регистрация аккаунта</h1>
            <div class="text-gray-400 fw-bold fs-4">Уже есть аккаунт?
                <a href="{{ route('login') }}" class="link-primary fw-bolder">Войдите</a></div>
        </div>

        <div class="fv-row mb-7">
            <label class="form-label fw-bolder text-dark fs-6">Имя Фамилия</label>
            <input
