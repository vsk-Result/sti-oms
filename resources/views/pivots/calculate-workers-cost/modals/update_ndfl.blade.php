<div class="modal fade" tabindex="-1" id="updateNDFLModal">
    <div class="modal-dialog">
        <form action="{{ route('pivots.calculate_workers_cost.ndfl.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Загрузите файл с НДФЛ или взносами</h4>
                </div>
