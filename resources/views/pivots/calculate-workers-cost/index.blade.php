        ...
        <div class="col-lg-12">
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-6">
                    <div class="card-title">Расчет стоимости рабочих по компании за 2024 год</div>

                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <form action="{{ route('pivots.calculate_workers_cost.exports.store') }}" method="POST" class="hidden">
                                    @csrf
                                    <a
