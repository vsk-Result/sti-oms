...
@section('title', 'Изменение оплаты для ' . $loan->name . ' (' . $loan->getType() . ')')
@section('toolbar-title', 'Изменение оплаты для ' . $loan->name . ' (' . $loan->getType() . ')')
@section('breadcrumbs', Breadcrumbs::render('loans.history.edit', $loan))
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">{{ 'Изменение оплаты для ' . $loan->name . ' (' . $loan->getType() . ')' }}</span>
                    </h3>
                </div>
                <div class="card-body py-3">
                    <form class="form" action="{{ route('loans.history.update', [$loan, $history]) }}?return_url={{ request()->get('return_url', '') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-5">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <input
                                                        ...
                                                        value="{{ old('planned_refund_date', $history->planned_refund_date) }}"
                                                        readonly
                                                />
                                            </div>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <input
                                                        ...
                                                        type="text"
                                                        name="refund_date"
                                                        value="{{ old('refund_date', $history->refund_date) }}"
                                                        readonly
                                                />
                                            </div>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="position-relative mb-3">
                                                    <input
                                                            ...
                                                            type="text"
                                                            name="amount"
                                                            value="{{ old('amount', $history->amount) }}"
                                                    />
                                                </div>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="position-relative mb-3">
                                                    <input
                                                            ...
                                                            type="text"
                                                            name="percent"
                                                            value="{{ old('percent', $history->percent) }}"
                                                    />
                                                </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <textarea
                                                    ...
                                                    name="description"
                                            >{{ old('description', $history->description) }}</textarea>
                                        </div>
                                    ...
                                    <div class="position-relative mb-3">
                                        <select name="status_id" data-control="select2" class="form-select form-select-solid form-select-lg">
                                            @foreach($statuses as $statusId => $status)
                                                <option value="{{ $statusId }}" {{ $statusId === $history->status_id ? 'selected' : '' }}>{{ $status }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
