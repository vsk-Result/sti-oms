    ...
    <div class="flex-grow-1">
        ...
        <div class="d-flex flex-wrap justify-content-start">
            @php
                ...
                $itrSalaryDebtDetails = $object->getITRSalaryDebtDetails();
                        ...
                        <div class="pivot-box position-relative w-100 d-flex flex-stack">
                            <div class="text-gray-700 fw-semibold fs-7 me-2">
                                <div
                                    ...
                                    data-bs-placement="top"
                                    data-bs-html="true"
                                    title="Детализация по долгу на зарплаты ИТР"
                                    data-title="Детализация по долгу на зарплаты ИТР"
                                    data-bs-content='@include('objects.parts.debts-details.itr_salary')'
                                >
