                    ...
                    <table class="table fs-6 fw-bold">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-danger">{{ number_format($object->getContractorDebtsAmount(), 2, '.', ' ') }}</td>
                            </tr>
                            <tr>
                                <td>Долг поставщикам</td>
                                <td class="text-danger">{{ number_format($object->getProviderDebtsAmount(), 2, '.', ' ') }}</td>
                            </tr>
                            <tr>
