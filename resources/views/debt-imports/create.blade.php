            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Загрузка долгов</span>
                    </h3>
                </div>
                <div class="card-body py-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 fv-row">
                            <label class="fs-5 fw-bold mb-2">Файл оригинал (для ДТТЕРМО)</label>
                            <input type="file" class="form-control form-control-solid" placeholder="" name="file_original" accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" />
                            <div class="form-text">Доступные форматы:
                                <code>xls, xlsx</code>
                            </div>
                        </div>
                    ...
                    <div class="d-flex flex-center py-3">
                        ...
                        <a href="{{ route('debt_imports.index') }}" class="btn btn-light">Отмена</a>
                    </div>
                </form>
            </div>
            </div>
