...
@section('content')
    ...
    @php
        ...
        $isGroupClosed = request()->input('group_closed_objects', ['true'])[0] == 'true';
            ...
            $generalCostsInfo = Illuminate\Support\Facades\Cache::remember('general_costs___1', now()->addHour(), function() use ($periodsByYears, $object27_1) {
                $generalInfo = [];
                $groupedByYearsInfo = [];
