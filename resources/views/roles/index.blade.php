                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        @can('edit admin-roles')
                                            <div class="menu-item px-3">
                                                <a href="{{ route('roles.edit', $role) }}" class="menu-link px-3">Изменить</a>
                                            </div>
                                            ...
                                            <div class="menu-item px-3">
                                                <form action="{{ route('roles.destroy', $role) }}" method="POST" class="hidden">
                                                    ...
                                                    <a
                                                        ...
                                                        onclick="event.preventDefault(); if (confirm('Вы действительно хотите удалить роль?')) {this.closest('form').submit();}"
                                                    >
                                                        Удалить
                                                    </a>
                                                </form>
