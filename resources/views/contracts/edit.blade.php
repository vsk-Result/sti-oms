...
@section('title', 'Изменение договора ' . $contract->name)
                ...
                <div class="card-body py-3">
                    <form class="form" action="{{ route('contracts.update', $contract) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <input
                                                                ...
                                                                type="text"
                                                                name="rad_percent"
                                                                value="{{ old('rad_percent', $contract->rad_percent) }}"
                                                        />
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <input
                                                                ...
                                                                value="{{ old('material_percent', $contract->material_percent) }}"
                                                        />
                                                    </div>
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <input
                                                                ...
                                                                value="{{ old('service_percent', $contract->service_percent) }}"
                                                        />
                                                    </div>
                        ...
                        @foreach ($contract->bankGuarantees as $bankGuarantee)
                            <a class="mb-5 fs-6" href="{{ route('bank_guarantees.edit', $bankGuarantee) }}">{{ $bankGuarantee->number }}</a>
                            <br/>
                        @endforeach

                        <a class="mt-5 btn btn-outline btn-outline-dashed btn-outline-success btn-active-light-success me-2 mb-2" href="{{ route('bank_guarantees.create') }}?current_contract_id={{ $contract->id }}&current_object_id={{ $contract->object_id }}">Добавить банковскую гарантию</a>

                        <h3 class="fw-bolder mb-5 mt-7">Гарантийное удержание</h3>

                        @foreach ($contract->guarantees as $guarantee)
                            <a class="mb-5 fs-6" href="{{ route('guarantees.edit', $guarantee) }}">{{ 'Гарантийное удержание #' . $guarantee->id }}</a>
                            <br/>
                        @endforeach

                        <a class="mt-5 btn btn-outline btn-outline-dashed btn-outline-success btn-active-light-success me-2 mb-2" href="{{ route('guarantees.create') }}?current_contract_id={{ $contract->id }}&current_object_id={{ $contract->object_id }}">Добавить гарантийное удержание</a>
