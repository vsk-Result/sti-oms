                ...
                <div class="card-header border-0 pt-6">
                    ...
                    @foreach(['RUB', 'EUR'] as $currency)
                        @foreach($subcontracts as $subcontract)
                            @php
                                $totalAmount[$currency] += $subcontract->getAmount(true, $currency);
                                $totalAvansesReceivedAmount[$currency] += $subcontract->getAvansesReceivedAmount(true, $currency);
                                $totalActsPaidAmount[$currency] += $subcontract->getActsPaidAmount(true, $currency);
                                $totalAvansesLeftAmount[$currency] += $subcontract->getAvansesLeftAmount(true, $currency);
                                $totalActsLeftPaidAmount[$currency] += $subcontract->getActsLeftPaidAmount(true, $currency);
                                $totalActsDepositesAmount[$currency] += $subcontract->getActsDepositesAmount(true, $currency);
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle table-row-dashed fs-6">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                @forelse($subcontracts as $subContract)
                                    <tr>
                                        <td class="px-3">
