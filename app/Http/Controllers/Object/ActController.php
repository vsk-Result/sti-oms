...
class ActController extends Controller
{
    ...
    public function index(BObject $object, Request $request): View
    {
        ...
        $isShowGroupedActs = in_array($object->code, ['360', '361', '363']);

        return view('objects.tabs.acts', compact('isShowGroupedActs', 'object', 'acts', 'total', 'objects', 'contracts', 'actsPaymentsLineChartInfo'));
    }
}
