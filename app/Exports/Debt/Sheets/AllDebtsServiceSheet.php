...
class AllDebtsServiceSheet implements
    WithTitle,
    WithStyles,
    ShouldAutoSize
{
    ...
    public function styles(Worksheet $sheet): void
    {
        ...
        foreach ($this->object_ids as $object_id) {
            ...
            $serviceDebts = $this->pivotObjectDebtService->getPivotDebts($object_id, PivotObjectDebt::DEBT_TYPE_SERVICE, ['with_sorted_details' => true]);
            foreach ($serviceDebts['organizations'] as $organization) {
...
//        }
        ...
        foreach ($final_array as $record) {
            ...
            $sheet->setCellValue('C' . $row, $record['avans']);
