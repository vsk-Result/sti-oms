...
class CashAccountService
{
    ...
    {
        $cashAccount->update([
            'balance_amount' => $cashAccount->start_balance_amount + $cashAccount->payments()->whereIn('status_id', [CashAccountPayment::STATUS_ACTIVE, CashAccountPayment::STATUS_VALID])->sum('amount')
        ]);
    }
