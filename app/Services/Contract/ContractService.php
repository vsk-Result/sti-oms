...
class ContractService
{
    ...
    public function filterContracts(array $requestData, array &$total, bool $needPaginate = true): LengthAwarePaginator|Collection
    {
        ...
        foreach ($currencies as $currency) {
            ...
            $total['avanses_left_amount_fix'][$currency] = 0;
            $total['avanses_left_amount_float'][$currency] = 0;
            $total['avanses_left_amount'][$currency] = 0;
    ...
    public function createContract(array $requestData): Contract
    {
        $contract = Contract::create([
            ...
            'rad_percent' => $this->sanitizer->set($requestData['rad_percent'])->toAmount()->get(),
            'material_percent' => $this->sanitizer->set($requestData['material_percent'])->toAmount()->get(),
            'service_percent' => $this->sanitizer->set($requestData['service_percent'])->toAmount()->get(),
            'stage_id' => 0,
