...
class ImportContractorDebtsFrom1CExcel extends HandledCommand
{
    protected $signature = 'oms:import-contractor-debts-from-1c-excel';
    ...
    public function handle()
    {
        ...
        $import = new ContractorImportFrom1C();
